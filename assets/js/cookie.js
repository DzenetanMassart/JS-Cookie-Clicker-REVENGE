...
function incrementation() {
    ...
    if (dispo_multi === 1 && dispo_bonus === 1 && dispo_TRICHE === 1) {
        ...
        document.getElementById('cookie').innerHTML = "Clic*" + multiplicateur + " !";
        //1_0_0
    ...
    montrons_bouttons();
    document.getElementById('cookie').innerHTML = "Clic !";
}
...
document.getElementById('cookie').addEventListener('click', incrementation);
